    ...
    alter table rpg_user_roles 
        drop constraint FK_oqqdn4mhhdltx2rjjfdp90qhu;

    alter table rpg_user_roles 
        drop constraint FK_gtu9hpnl1eix5rbt68jga6wik;

    drop table if exists rpg_role cascade;

    drop table if exists rpg_user cascade;

    drop table if exists rpg_user_roles cascade;
